(function () {
	...
	*/
	...
	reactIs_production_min.isValidElementType = function (a) {
	  return "string" === typeof a || "function" === typeof a || a === e || a === m$1 || a === g$1 || a === f$1 || a === p$1 || a === q$1 || "object" === typeof a && null !== a && (a.$$typeof === t || a.$$typeof === r || a.$$typeof === h$1 || a.$$typeof === k || a.$$typeof === n$1 || a.$$typeof === w || a.$$typeof === x || a.$$typeof === y || a.$$typeof === v);
	};
	...
	var Flap = function Flap(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: classes
	  }, children, hinge && /*#__PURE__*/React.createElement("div", {
	...
	var FlapDigit = function FlapDigit(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    ...
	    "data-kind": "digit",
	    "data-mode": mode
	  }, /*#__PURE__*/React.createElement(Flap, restProps, value), /*#__PURE__*/React.createElement(Flap, _extends({
	    bottom: true
	  }, restProps), prevValue), /*#__PURE__*/React.createElement(Flap, _extends({
	    key: "top-".concat(prevValue),
	    animated: true,
	    "final": _final
	  }, restProps), prevValue), _final && /*#__PURE__*/React.createElement(Flap, _extends({
	...
	var FlapStack = function FlapStack(_ref) {
	  ...
	  var _useState = react.exports.useState(InitialCursor),
	  ...
	  return /*#__PURE__*/React.createElement(FlapDigit, _extends({
	    value: stack[current],
	...
	var FlapDisplay = function FlapDisplay(_ref) {
	  var id = _ref.id,
	      ...
	      words = _ref.words,
	      length = _ref.length,
	      padChar = _ref.padChar,
	      padMode = _ref.padMode,
	      render = _ref.render,
	  ...
	  var _useState3 = react.exports.useState(Modes.Numeric),
	  ...
	  react.exports.useEffect(function () {
	    setChildren(digits.map(function (digit, i) {
	      return /*#__PURE__*/React.createElement(FlapStack, _extends({
	        key: i,
	        stack: stack,
	        value: digit,
	        mode: mode
	...
	function Dimmer() {
	  const [isOn, setIsOn] = react.exports.useState(false);
	...
	function Clock() {
	  const [time, setTime] = react.exports.useState(new Date());
	  ...
	  return /*#__PURE__*/jsxRuntime.exports.jsxs("div", {
	    ...
	    children: [/*#__PURE__*/jsxRuntime.exports.jsx(FlapDisplay, {
	    ...
	    }), /*#__PURE__*/jsxRuntime.exports.jsx(FlapDisplay, {
	      className: "gruvbox light-bottom",
	      chars: charSet,
	      length: 17,
	      value: padText(time)
	...
	function App() {
	  return /*#__PURE__*/jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, {
	    children: [/*#__PURE__*/jsxRuntime.exports.jsx(Clock, {}), /*#__PURE__*/jsxRuntime.exports.jsx(Dimmer, {})]
	  });
	}

	let domContainer = document.querySelector("#clock");
	ReactDOM.render( /*#__PURE__*/jsxRuntime.exports.jsx(App, {}), domContainer);
